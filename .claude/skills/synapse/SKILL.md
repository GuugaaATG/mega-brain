...
**Architecture model:** Open Core — the 8-layer engine lives in `.aiox/core/synapse/`, memory integration is feature-gated as a pro capability.
...
.claude/hooks/synapse-engine.js          # Layer 1: Hook Entry (~50 lines)
        |
        v imports
.aiox/core/synapse/                 # Layer 2: Engine Modules
