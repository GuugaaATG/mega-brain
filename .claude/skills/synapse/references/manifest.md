...
The manifest is parsed by `domain-loader.js` (`.aiox/core/synapse/domain/domain-loader.js`) on every prompt.
...
| `.aiox/core/synapse/domain/domain-loader.js` | Manifest parser + domain file loader |
