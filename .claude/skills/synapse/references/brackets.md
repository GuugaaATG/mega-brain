...
The bracket system is implemented in `.aiox/core/synapse/context/context-tracker.js`.
...
The output formatter (`.aiox/core/synapse/output/formatter.js`) enforces token budgets:
...
| File | Purpose |
|------|---------|
| `.aiox/core/synapse/context/context-tracker.js` | Bracket calculation, token budgets, layer configs |
| `.synapse/context` | Bracket-specific context rules (L1) |
| `.aiox/core/synapse/output/formatter.js` | Token budget enforcement + truncation |
