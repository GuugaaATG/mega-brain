...
SYNAPSE processes rules through an 8-layer pipeline executed sequentially on every prompt. Each layer has a specific purpose, trigger condition, and priority level. The engine orchestrator (`.aiox/core/synapse/engine.js`) chains all layers and the output formatter produces the final `<synapse-rules>` XML block.
...
| **Source** | Auto-generated from `.aiox/constitution.md` via `generate-constitution.js` |
| **Implementation** | `.aiox/core/synapse/layers/l0-constitution.js` |
...
| **Implementation** | `.aiox/core/synapse/layers/l1-global.js` |
...
| **Implementation** | `.aiox/core/synapse/layers/l2-agent.js` |
...
| **Implementation** | `.aiox/core/synapse/layers/l3-workflow.js` |
...
| **Implementation** | `.aiox/core/synapse/layers/l4-task.js` |
...
| **Implementation** | `.aiox/core/synapse/layers/l5-squad.js` |
...
| **Implementation** | `.aiox/core/synapse/layers/l6-keyword.js` |
...
| **Implementation** | `.aiox/core/synapse/layers/l7-star-command.js` |
...
| File | Purpose |
|------|---------|
| `.aiox/core/synapse/engine.js` | SynapseEngine orchestrator |
| `.aiox/core/synapse/layers/l0-constitution.js` | L0 processor |
| `.aiox/core/synapse/layers/l1-global.js` | L1 processor |
| `.aiox/core/synapse/layers/l2-agent.js` | L2 processor |
| `.aiox/core/synapse/layers/l3-workflow.js` | L3 processor |
| `.aiox/core/synapse/layers/l4-task.js` | L4 processor |
| `.aiox/core/synapse/layers/l5-squad.js` | L5 processor |
| `.aiox/core/synapse/layers/l6-keyword.js` | L6 processor |
| `.aiox/core/synapse/layers/l7-star-command.js` | L7 processor |
| `.aiox/core/synapse/layers/layer-processor.js` | Abstract base class |
| `.aiox/core/synapse/output/formatter.js` | XML formatter + token budget |
