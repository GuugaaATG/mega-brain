...
```json
{
  ...
  "source_company": "Closers.io",
  "original_path": "/00-INBOX/COLE-GORDON/video.mp4",
...
| Empresa | "Closers.io" | Mapear para companies |
...
```json
{
  ...
  "entities_found": {
    ...
    "companies": ["Closers.io", "Acquisition.com"],
...
ARQUIVOS GERADOS
├── /01-PROCESSING/chunks/CG004-chunks.json
├── /01-PROCESSING/insights/CG004-insights.json
├── /02-KNOWLEDGE/SOURCES/COLE-GORDON/SOURCE-CG004.md
├── /02-KNOWLEDGE/DOSSIERS/PERSONS/DOSSIER-COLE-GORDON.md (atualizado)
